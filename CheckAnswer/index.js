...
module.exports = async function (context, req) {
    ...
    if (req.params.gameId &&
        ...
        try {
            ...
            const gameResult = await storage.retrieveEntity(tableSvc, tables.games, tables.games, gameId);
            ...
            const questionResult = await storage.queryEntities(tableSvc, tables.questions, new azure.TableQuery()
            ...
            if (questionResult.entries.length) {
                ...
                let team = await storage.retrieveEntity(tableSvc, tables.teams, tables.teams, teamId);
                ...
                await storage.mergeEntity(tableSvc, tables.teams, team);
