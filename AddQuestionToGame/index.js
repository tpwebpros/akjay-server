...
module.exports = async function (context, req) {
    ...
    {  
        ...
        try {
            ...
            let existingQuestion = await storage.retrieveEntity(tableSvc, tables.questions, tables.questions, questionId);

            let associatedQuestions = JSON.parse(existingGame.questions._);
